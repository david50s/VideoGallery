...
function vbeginFunction() {
   ...
   // activityTimeout = setTimeout(inActive, 10 * 1000); //1 hour
...
function vendFunction() {
    ...
    //clearTimeout(activityTimeout);
   // activityTimeout = setTimeout(inActive, 10 * 1000);//5 minutes
    //console.log(activityTimeout);
}
function closeGal() {
    $.fancybox.close();
...
$(document).ready(function () {
    ...
    //  display the current and remaining times
        ...
        $.fancybox({
            ...
            afterShow: function() {
               // activityTimeout = setTimeout(inActive, 10 * 1000); //10 sec
                $("#clicktostart").append("<p><progress id='pbar' value='50' max='100'></progress><span id='curtimetext'> </span> / <span  id='durtimetext'></span></p>");
...
/*var activityTimeout = setTimeout(inActive, 10000);//300000
